...
<head>
    ...
    <meta name="description" content="Add Facebook events using ical. Filters out events you are not attending to or has not responded to.">
</head>
...
<body>
    ...
    <div class="container">
        ...
        <p class="open-source-desc">
            ...
            <br>
            <br>
            <iframe style="margin-left: 25px" src="https://ghbtns.com/github-btn.html?user=simonbengtsson&repo=eventcal&type=star&count=true&size=large" frameborder="0" scrolling="0" width="160px" height="30px"></iframe>
            <br>
            <br>
            <span style="color: #aaa">Updated: 15 Aug 2023 v2</span>
        </p>
